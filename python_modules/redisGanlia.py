...
def metric_init(params={}):
    ...
    #print metric_handler.host ":" metric_handler.port
    ...
    for name, updates in metrics.iteritems():
        descriptor = {
            "name": "%s-%s:%s"%(name,metric_handler.host,metric_handler.port),
            ...
            "groups": "redis:%s:%s"%(metric_handler.host,metric_handler.port),
        }
